import WaveShort from "../backgrounds/WaveShort";

export default function TermsSection() {
  return (
    <div className="overflow-hidden 4xl:pb-[100px]">
      <WaveShort />
      <div className="mx-auto max-w-[1234px] px-[30px] pt-[140px] pb-[30px] max-lg:gap-[60px] max-lg:px-5 max-lg:pt-[150px] max-lg:pb-[290px]">
        <div className="grid gap-[10px]">
          ...
          <p className="text-[17px] font-normal leading-[130%] text-black max-xs:text-[15px] max-xs:leading-[100%] dark:text-white">
            Lucferbux is committed to ensuring that the app is as useful and
          ...
          <p className="text-[17px] font-normal leading-[130%] text-black max-xs:text-[15px] max-xs:leading-[100%] dark:text-white">
            You should be aware that there are certain things Lucferbux will not
            take responsibility for. Certain functions of the app will require
          ...
          <p className="text-[17px] font-normal leading-[130%] text-black max-xs:text-[15px] max-xs:leading-[100%] dark:text-white">
            Along the same lines, Lucferbux cannot always take responsibility
          ...
          <p className="text-[17px] font-normal leading-[130%] text-black max-xs:text-[15px] max-xs:leading-[100%] dark:text-white">
            With respect to Lucferbux&apos;s responsibility for your use of the
            ...
            information to us so that we can make it available to you. Lucferbux
          ...
          <p className="text-[17px] font-normal leading-[130%] text-black max-xs:text-[15px] max-xs:leading-[100%] dark:text-white">
            ...
            want to keep using the app. Lucferbux does not promise that it will
