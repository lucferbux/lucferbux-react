    ...
    >
      ...
      >
        ...
        <img
          ...
          alt="Decorative Ring"
          className="absolute top-1/2 left-1/2 max-w-none -translate-x-1/2 -translate-y-1/2 transition-transform duration-600 ease-[cubic-bezier(0.075,0.82,0.165,1)] group-hover:rotate-[30deg] group-hover:scale-120 group-active:rotate-[10deg] group-active:scale-110"
        />
      </div>
    </a>
  );
